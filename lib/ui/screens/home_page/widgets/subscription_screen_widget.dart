...
import 'package:anton_zyryanov_barcode_scanner/ui/components/subscription_plan_cell_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox.expand(
      child: Stack(
        ...
        children: [
          Image.asset(
            'assets/images/paywall/paywall_background.jpg',
            fit: BoxFit.cover,
          ),
                ...
                child: AnimatedFadeSlideWidget(
                  child: SizedBox(
                    ...
                    child: InfoAlertWidget(
                      iconPath:
                          'assets/images/paywall/subscription_bought_icon.png',
